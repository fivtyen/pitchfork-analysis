...
class PitchforkSpider(scrapy.Spider):
    ...
    start_urls = ['http://pitchfork.com/reviews/albums/?page=' + str(n) for n in range(1, 100)]
    ...
    def parse_review(self, response):
        artist = response.xpath('//h2[@class="artists"]/ul[@class="artist-links artist-list"]/li/a/text()').extract_first()
        ...
        review_author_url = 'pitchfork.com' + response.xpath('//a[@class="display-name"]/@href').extract_first()
